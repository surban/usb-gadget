...
echo "    CARGO_TARGET_X86_64_UNKNOWN_LINUX_GNU_RUNNER='.ci/cargo-test-runner.sh' \\"
echo "      cargo test --release --all-features -- --nocapture --test-threads=1 --skip audio --skip video"
echo ""
echo "  To upload as a GitHub Release asset:"
echo "    gh release create kernel-v${KERNEL_VERSION} $OUTPUT"
echo "════════════════════════════════════════════════════════"
